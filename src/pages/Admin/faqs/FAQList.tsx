                ...
                <div className="flex flex-col gap-6 w-full max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex flex-col gap-1">
                            <h1 className="font-medium text-2xl tracking-tight">{t('admin.faqs.page_title')}</h1>
                            <p className="text-sm text-muted">{t('admin.faqs.page_subtitle')}</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        <div className="flex items-center justify-end gap-2 w-full h-fit">
                            <Link to={PATHS.ADMIN.FAQ_CREATE} className="flex items-center px-3 py-1.5 border border-muted/15 rounded-full bg-emphasis">
                                ...
                                <span className="font-medium text-sm">{t('admin.faqs.add_item')}</span>
                            </Link>
                        </div>
