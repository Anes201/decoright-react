...
function Spinner({ status=true, children = 'Loading...', className = '', size = 'md' }: Props) {
  ...
  return (
    <div className="relative inline-block">
      ...
      {status && (
        <div role="status" aria-live="polite" className={overlayClass}>
          <svg aria-hidden="true" className={`${sizeClass} text-emphasis animate-[spin_0.7s_linear_infinite] fill-primary`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
