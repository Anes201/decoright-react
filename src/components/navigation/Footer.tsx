            ...
            <div className="flex max-md:flex-col items-center md:justify-between gap-8">
                ...
                <div className="flex max-sm:flex-col max-sm:items-center gap-4 md:gap-8 mb-6 md:mb-0">
                    ...
                    <div className="max-sm:text-center">
                        ...
                        <p className="text-2xs text-muted/75 max-w-xs">
                            {companyName} is your trusted partner for exquisite interior design and decor solutions. We bring your vision to life with creativity and style.
                        </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul className="flex justify-center md:justify-end gap-4">
                        <li>
                            <Link to={facebook || '/'} title="Facebook" className="content-center p-2" target={facebook ? "_blank" : undefined}>
                                <ICONS.facebook />
                            </Link>
                        </li>
                        <li>
                            <Link to={tiktok || '/'} title="Tiktok" className="content-center p-2" target={tiktok ? "_blank" : undefined}>
                        ...
                        <li>
                            <Link to={instagram || '/'} title="Instagram" className="content-center p-2" target={instagram ? "_blank" : undefined}>
                        ...
                        <li>
                            <Link to={youtube || '/'} title="Youtube" className="content-center p-2" target={youtube ? "_blank" : undefined}>
                        ...
                        <li>
                            <Link to={whatsappUrl} title="Whatsapp" className="content-center p-2" target={whatsapp ? "_blank" : undefined}>
